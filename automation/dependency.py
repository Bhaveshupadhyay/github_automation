...
class Container:
    ...
    def __init__(self):
        ...
        self._summarizer_service: Optional[ISummarizerService] = None
    ...
    def get_summarizer_service(self) -> ISummarizerService:
        if self._summarizer_service is None:
            self._summarizer_service = GeminiLLMSummarizerService(self.config)
